...
```
In 2002, `r states_2002$locationabbr` those `r nrow(states_2002)` states were observed at 7 or more locations. \
In 2010, `r states_2010$locationabbr` those `r nrow(states_2010)` states were observed at 7 or more locations.
```{r}
# Spaghetti plot
excellent_data <- 
  cleaned_bs2010 |>
